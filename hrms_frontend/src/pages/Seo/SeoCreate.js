...
const seoUpdateEndpoint = ApiEndpoints.seo.seoCreate;
export default function SeoCreate() {
  ...
  const pagename = {
    name: 'SEO Management',
    user: 'Admin',
    innerpage: 'SEO Management / SEO / Add SEO'
  }
  ...
  return (
   ...
   <div className="add-content-page">
        <form id="seoAdd" onSubmit={handleSubmit}>
        ...
        <button type="submit" form="seoAdd" className="default-btn">
          Publish <span></span>
        </button>
      </div>
    </>
